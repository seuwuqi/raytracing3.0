...
#include "../../Demo1/src/echoserver.h"
...
QT_MOC_LITERAL(11, 122, 9), // "isDynamic"
QT_MOC_LITERAL(12, 132, 4), // "time"
QT_MOC_LITERAL(13, 137, 10) // "DynamicVPL"

    },
    "EchoServer\0closed\0\0onNewConnection\0"
    "processTextMessage\0message\0"
    "socketDisconnected\0updateScene\0"
    "jsonObject\0updateVehicle\0VPL\0isDynamic\0"
    "time\0DynamicVPL"
};
...
static const uint qt_meta_data_EchoServer[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, QMetaType::QJsonObject,    8,
    QMetaType::QJsonObject, QMetaType::Bool, QMetaType::Double,   11,   12,
...
void EchoServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: { QJsonObject _r = _t->VPL((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< QJsonObject*>(_a[0]) = std::move(_r); }  break;
        case 7: { QJsonObject _r = _t->DynamicVPL();
            if (_a[0]) *reinterpret_cast< QJsonObject*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
